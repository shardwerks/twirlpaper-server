...
ALTER TABLE `cpg14x_users` ADD `userhash` INT( 32 ) NOT NULL DEFAULT '00000000000000000000000000000000'

CREATE USER 'tinterface'@'localhost' IDENTIFIED BY '*9EDFB008D0C4A10AF4B881BECEB1CBA9C45C2844';
GRANT SELECT , INSERT , UPDATE , 
DELETE ON * . * TO 'tinterface'@'localhost' IDENTIFIED BY '*9EDFB008D0C4A10AF4B881BECEB1CBA9C45C2844'
