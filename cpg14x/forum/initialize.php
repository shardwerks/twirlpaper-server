<?php
// copyright
$fr_copyright = "<div class=\"footer\" align=\"center\"><a href=\"http://cpgsf.amfcvn.net/forum.php\">Coppermine Simple Forum ".$CONFIG['fr_version']."</a> &#169; <a href=\"http://forum.coppermine-gallery.net/index.php?action=profile;u=3924\">foulu</a></div>";
...
// if admin page
if (substr_count($c, 'admin') > 0) { // by muu
    if (!GALLERY_ADMIN_MODE) {
        cpg_die(ERROR, Lang::item('error.access_denied'), __FILE__, __LINE__);
    }
}
// convert to file path
$source_file = BASE_DIR.'forum'.DS.'sources'.DS.$c.'.php';
